...
#ifndef ANDROMEDA_INTERFACES
#define ANDROMEDA_INTERFACES

/* Includes module pinout */
#include <Andromeda/Interfaces/interfaces_pinout.h>

/* Includes module protocol */
#include <Andromeda/Interfaces/interfaces_protocol.h>
